...
//    private List<EditText> mListEditTexts;
//    private View mView;
//    private List<View> mListViews;
//    private int[] mListenedResId;  // 要监听的控件id
...
////        this.mListenedResId = listenedItems;
////    }
////
////    /**
////     * @param context
...
//        //遍历控件id,添加点击事件
//        for (int id : mListenedResId) {
//            mView = findViewById(id);
//            mView.setOnClickListener(this);
//            mListViews.add(mView);
//        }
////        for (int id : mEdtResId) {
////            mEditText = (EditText) findViewById(id);
////            mListEditTexts.add(mEditText);
////        }
//    }
//
//    /**
